...
URLS = "https://api.eia.gov/series/?api_key=642c17f567bb726530c47a1e2e0ef433&series_id="


#URLTXT = "http://api.eia.gov/series/?api_key=642c17f567bb726530c47a1e2e0ef433&series_id=EBA.AVA-ALL.NG.NUC.HL"
...
for a in range(0, len(BA)):
    ...
    for b in range(0,len(FT)):
        ...
        URL = URLS+SeriesID
        #URL = 'https://api.eia.gov/series/?api_key=642c17f567bb726530c47a1e2e0ef433&series_id=EBA.SRP-ALL.NG.SUN.HL'
        #uClient = uReq(URL)
