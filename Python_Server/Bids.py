...
url = 'http://oasis.caiso.com/oasisapi/GroupZip?resultformat=6&version=2&groupid=PUB_RTM_GRP&startdatetime=20180701T08:00-0000'
...
dt.to_sql('CAISO_Bids_Landing', engine, schema = 'dbo', index = False, if_exists='replace')
