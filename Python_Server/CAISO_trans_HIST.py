...
for i in range(30):
    ...
    DD = datetime.date.today()+datetime.timedelta(days=d+1)
    DD1 = datetime.date.today()+datetime.timedelta(days= d-1)
    DED = DD.strftime('%Y%m%d')
    DD2  =datetime.date.today()+datetime.timedelta(days=d+2)
