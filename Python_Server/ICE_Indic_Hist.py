...
password = 'settledata'
yr=['2007','2008','2009','2010','2011','2012','2013','2014','2015','2016','2017']
    ...
    for m in range(len(mn)):
        ...
        for d in range(len(dn)):
            try:
                ...
                df.to_sql('ICEGASINDIC_Landing', engine, schema = 'dbo', index = False, if_exists='replace')
                time.sleep(1)
                sql = 'EXEC dbo.GASINDICES_Upload'
