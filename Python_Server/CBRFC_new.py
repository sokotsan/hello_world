...
#sting=str(soup.find_all('pre'))
    ...
    CBRFC['YR']=np.where(CBRFC['MN'].astype(int)-datetime.datetime.today().month <=-7, datetime.datetime.today().year+1, datetime.datetime.today().year) 
   # CBRFC['HR'] = 
...
#%%
#CBRFC['YR']=datetime.datetime.today().strftime("%Y")

 
#print(CBRFC.head(150))
