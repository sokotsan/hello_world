...
#S:\FUNDIES\Clients\Stefan Baden

thefile = 'S:/FUNDIES/Clients/Stefan Baden/HYbackfill.csv'
...
dt.to_sql('EGPSHY_Backfill', engine, schema = 'dbo', index = False, if_exists='replace')
