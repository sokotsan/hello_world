...
a=[]
url = 'http://oasis.caiso.com/oasisapi/SingleZip?resultformat=6&queryname=SLD_FCST_PEAK&version=1&startdatetime='+DT1+'T08:00-0000&enddatetime='+dt2+'T07:00-0000'
...
dt.to_sql('CAISO_LD_PK_FCST_Landing', engine, schema = 'dbo', index = False, if_exists='replace')

import time
time.sleep(3)
sql = 'EXEC dbo.Upload_CAISO_PK_LD_FC'
