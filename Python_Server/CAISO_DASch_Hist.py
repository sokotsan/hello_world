...
for y in range(len(yr)):
    ...
    for m in range(len(mn)):
        try:
            ...
            url = 'http://oasis.caiso.com/oasisapi/SingleZip?resultformat=6&queryname=ENE_SLRS&version=1&market_run_id=DAM&tac_zone_name=ALL&schedule=ALL&startdatetime='+YR+MN+'01T07:00-0000&enddatetime='+YR+MM+'01T07:00-0000'
            #http://oasis.caiso.com/oasisapi/SingleZip?resultformat=6&queryname=ENE_SLRS&version=1&market_run_id=DAM&tac_zone_name=ALL&schedule=ALL&startdatetime=20190710T07:00-0000&enddatetime=20190713T07:00-0000
